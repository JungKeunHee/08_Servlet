...
public class SessionHandlingServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        *   저번에 했던 것처럼 request 객체가 전혀 다른 객체이기 때문이다
        *  */
//        resp.sendRedirect("redirect");
        ...
        *   하지만 쿠키는 보안상의 단점과 지원하지 안흔ㄴ 브라우저 등의
        ...
        * */
        ...
        // 세션을 만료시킬 수 있는 유효시간 / 기본 설정 시간 : 30분 (초 단위로 나옴)
        ...
        */
        ...
        /* comment.
        *   무리가 공유할 값을 담을 때는 setAttribute(String Key, Object Value)
        *   형태로 담게 된다
        *  */
